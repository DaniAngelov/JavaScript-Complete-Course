...
this rule, a
team only wins if it has a higher score than the other team, and the
 same time a score of at least 100 points. Hint: Use a logical
 operator to test for minimum score, as well as multiple else-if
  blocks
...
Test data:
 ...
 and 123
 Data Bonus 2: Dolphins score 97, 112 and 101. Koalas score 109, 95
and 106*/

const dolphinesScores1 = 97;
const dolphinesScores2 = 112;
const dolphinesScores3 = 101;
const koalasScores1 = 109;
const koalasScores2 = 95;
const koalasScores3 = 106;

// 1.

avgDolphinesScore = (dolphinesScores1 + dolphinesScores2 + dolphinesScores3) / 3;
avgKoalasScore = (koalasScores1 + koalasScores2 + koalasScores3) / 3;

console.log("AVG dolphines score: " + avgDolphinesScore);
console.log("AVG koalas score: " + avgKoalasScore);
// 2.

if (avgDolphinesScore > avgKoalasScore) {
    console.log("Dolphines won !");
} else if (avgDolphinesScore < avgKoalasScore) {
...
if (avgDolphinesScore > avgKoalasScore && avgDolphinesScore >= 100) {
    console.log("Dolphines won !");
} else if (avgDolphinesScore < avgKoalasScore && avgKoalasScore >= 100) {
    console.log("Koalas won !");
} else {
    console.log("It's a draw!");
}
